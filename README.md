...
Region_material_Japan by Hitoshi Uchida "HiTouch"

日本地形テクスチャデータにおけるランウェイ黄色マーキングの設定ファイルです。  
Configuration file for runway yellow marking in Japanese terrain texture data.
